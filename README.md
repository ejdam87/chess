...
In the future, I plan to add also a bot based on alpha-beta algorithm (optimization of min-max) and maybe some reinforcement learning or other ML techniques.
